...
trait Agriculture:
  ...
  */
  val yes: Double
  val his: Double
  def resourceProduction(es_graph: Graph[(EcoUnit,Double), Long]): Double =
...
object Agriculture:
  ...
  */
  ...
  Double =
    ...
    val low_intensity : Graph[(EcoUnit,Double),Long] = es_graph.subgraph( vpred = (_,attr) => attr._1.cover == LandCover.LowIntensity )
